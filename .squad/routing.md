...
|-----------|----------|----------|
| Architecture & decisions | Neo | System design, API contracts, tech choices, code review |
| Frontend & UI | Trinity | React components, styling, UX, client-side state |
| Backend & APIs | Morpheus | Express server, REST endpoints, WebSocket, file I/O |
